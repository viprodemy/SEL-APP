    ...
    <>
      <SidebarHeader>
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-headline text-xl font-bold group-data-[collapsible=icon]:hidden">SEL Assistant</h1>
        </div>
      </SidebarHeader>
      <SidebarContent>
        <SidebarMenu>
    ...
    <SidebarProvider>
        <div className="md:hidden flex items-center justify-between p-4 border-b">
          <div className="flex items-center gap-2">
            ...
            <h1 className="font-headline text-xl font-bold">SEL Assistant</h1>
          </div>
          <Sheet>
